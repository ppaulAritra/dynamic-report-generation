package com.aritra.report.common.util;
...
public class DateTimeUtils {
    ...
    public static final String DATE_TIME_FORMAT_1 = "yyyy-MM-dd HH:mm:ss aa";
...
//        date.add(Calendar.DAY_OF_YEAR, -1);
    ...
    public static String toDateAndTimeString(Date date) {
        SimpleDateFormat df = new SimpleDateFormat(DATE_TIME_FORMAT_1);
        return df.format(date);
    }
...
//    }
    ...
    public static Calendar getStartOfMonthExclusive(int month, int year) {
        Calendar calStart = Calendar.getInstance();
    ...
    public static Calendar getEndOfMonthExclusive(int month, int year) {
        Calendar calEnd = Calendar.getInstance();
    ...
    public static Calendar setLocalHour(Date date) {
        Calendar calendar = Calendar.getInstance();
    ...
    //this one used only to bind time with date
    public static Date combineDateAndTime(Date date, String time) {
        System.out.println("Date is " + date.toString() + "  and time is " + time);
    ...
    public static Date dateWithTZ() throws ParseException {
        ...
        readFormat.setTimeZone(TimeZone.getTimeZone("GMT"));
